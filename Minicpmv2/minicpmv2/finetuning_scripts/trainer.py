...
class CPMTrainer(Trainer):
    ...
    def training_step(self, model: nn.Module, inputs: Dict[str, Union[torch.Tensor, Any]], optimizer: Optional[torch.optim.Optimizer] = None) -> torch.Tensor:
        """
        ...
        Args:
            ...
            optimizer (`Optional[torch.optim.Optimizer]`): The optimizer being used (optional).
