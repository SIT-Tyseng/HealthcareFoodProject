...
def bing_image_scraper(query, num_images, save_dir):
    """Scrape Bing Images with size, format, and commercial use license validation"""
    headers = {
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36',
        'Referer': 'https://www.bing.com/'
    }
    
    # Add license filter for commercial use (Public Domain, Free to use or share commercially, Free to use, share, or modify commercially)
    search_url = f"https://www.bing.com/images/search?q={quote_plus(query)}&qft=+filterui:imagesize-medium+filterui:photo-photo+filterui:license-L1_L3_L5"
