...
root_dir = '../custom_data/SGFood-Generated'
...
with open('sgfood_sharegpt_train.json', 'w') as f:
    json.dump(train_data, f, indent=4)

# Save the test dataset to vqa_test.json
with open('sgfood_sharegpt_test.json', 'w') as f:
    json.dump(test_data, f, indent=4)

print("SGFood dataset generated and split into sgfood_sharegpt_train.json (85%) and sgfood_sharegpt_test.json (15%)")